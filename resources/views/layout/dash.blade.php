...
<head>
    ...
    <title>@yield('title') - RoomFolio</title>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('home') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2">RoomFolio</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div class="text-truncate" data-i18n="Floor Details">Floor Details</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('FloorDetailsadd') }}" class="menu-link">
                                    <div class="text-truncate" data-i18n="Add">Add</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('FloorDetails') }}" class="menu-link">
                                    <div class="text-truncate" data-i18n="Show">Show</div>
                                </a>
                            </li>
                        </ul>
                                    ...
                                    <li>
                                        <form action="{{ route('logout') }}" method="POST">
                                            ...
                                            <button class="dropdown-item" type="submit"><i
                                                    class="bx bx-power-off bx-md me-3"></i><span>Log
                                                    Out</span></button>
                                        </form>
                                    </li>
                                </ul>
                        ...
                        <div class="container-xxl">
                            <div
                                ...
                                <div class="text-body">
                                    ...
                                    , Developed by
                                    <a href="{{ route('home') }}" class="footer-link">RoomFolio</a>
                                </div>
                            </div>
                        </div>
                    </footer>
